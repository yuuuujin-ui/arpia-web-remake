...
(()=>{
 ...
 Object.assign(x.npcs,{hint1:{name:'첫 번째 힌트 쪽지'},hint2:{name:'두 번째 힌트 쪽지'},stargate:{name:'별모양 돌문'},rainbowworm:{name:'레인보우 웜',portraitPath:'assets/rainbow-worm.png',height:112},skeleton:{name:'해골 병사'}});
 Object.assign(x.encounters,{rainbowworm:{name:'잊힌 궁전 · 레인보우 웜',bg:'assets/forgotten-palace.png',intro:'약물에 오염된 레인보우 웜이 길을 막았습니다. 긴 싸움에 대비하세요.',next:110,xp:140,gold:110,sp:40,enemies:[{name:'레인보우 웜',element:2,hp:420,maxHp:420,atk:18,atb:8,sprite:'rainbowWorm'}]}});
 ...
 103:['minedepths','jackal',[['jackal','그 녀석 약속을 잊은 건 아닐지 모르겠군.'],['you','기욤 말씀이죠? 어제 알려 준 길부터 확인해요.'],['scoll','이번에는 저를 물지 않으실 거죠?'],['jackal','자네가 조용히 따라온다면 생각해 보지.']]],
 104:['minedepths','guillaume',[['guillaume','누구시더라? 길을 알고 싶으면 금덩이 세 개를…'],['jackal','어제 이미 받지 않았나. 또 거래를 하겠다는 건가?'],['guillaume','아, 기억났습니다! 농담이었죠. 북쪽 길 끝의 계단으로 가시면 잊힌 궁전입니다.'],['scoll','이번에는 길을 잊지 말게.']]],
  110:['palacechamber','skeleton',[['skeleton','전투가… 끝났군. 누군가 지렁이에게 약물을 주입해 광석을 오염시켰다.'],['you','그래서 왕국에 간 철만 보랏빛 마력에 약해진 거군요.'],['scoll','이 약물 조각을 가져가면 광산과 왕국 모두에게 설명할 수 있겠어.'],['jackal','조심해서 보관해라. 살아 있는 증언만큼 남아 있는 흔적도 중요하니.'],['skeleton','범인은 더 깊은 어둠으로 사라졌다. 다음에는 조심해라.']]],
 ...
 x.interact=(e,a)=>{const s=a.state,q=s.stage;
  if(q===105&&s.scene==='dwarfpalace'&&e.id==='hint1'){s.palaceHint1=true;a.advance(106,10);a.refresh();a.talk([['jackal','여기가 난쟁이 족 궁전의 미로 방일세.'],['you','모양이 다른 문과 갈림길이 이어져 있어요. 그냥 달려가면 되돌아오기 힘들겠는데요.'],['scoll','그럼 눈에 띄는 단서를 하나씩 기억해 두세. 저쪽에 쪽지가 있군.'],['narrator','낡은 쪽지에는 네 자리 모양 “-__-”가 적혀 있다.'],['you','양끝은 위에, 가운데 둘은 아래에 놓였어요. 문을 열 때 쓰는 힌트인지 다른 쪽지도 찾아봐요.']]);a.save();return true;}
