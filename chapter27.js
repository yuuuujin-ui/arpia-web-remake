...
(()=>{
 ...
 x.encounters.zombieNews27={name:'광산 안쪽 방 · 좀비 세자매',bg:'assets/dwarf-mine-depths.png',intro:'기욤의 금덩이 세 개를 되찾으세요.',next:c.keys.goldBack,xp:350,gold:105,sp:52,enemies:[{name:'좀비 첫째',element:2,hp:420,maxHp:420,atk:23,atb:0,npc:'zombieSisters',spriteRegion:0},{name:'좀비 둘째',element:2,hp:390,maxHp:390,atk:22,atb:12,npc:'zombieSisters',spriteRegion:1},{name:'좀비 셋째',element:2,hp:360,maxHp:360,atk:21,atb:24,npc:'zombieSisters',spriteRegion:2}],onWin:s=>m.give(s,'gold27',3)};
